...
public class MashLayer_editor : Editor
{
    ...
    { 
        ...
        EditorGUILayout.LabelField("<b><color=#0068FF>Mesh_SortingLayers v1.2:</color></b>", style);
        MeshRenderer ren = target as MeshRenderer;//^-^
        ...
        EditorGUILayout.EndHorizontal();
            ...
            else
            {
                ...
                else
                {
                    ...
                    EditorGUILayout.EndHorizontal();
                    //begin and chande val of layer oder
                    EditorGUILayout.BeginHorizontal();
                    EditorGUI.BeginChangeCheck();
